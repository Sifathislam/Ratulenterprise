...
class ProductCloneTable(models.Model):
    ...
    vendor = models.ForeignKey(Vendor, on_delete=models.CASCADE, related_name='staged_products')
    slug = models.SlugField(max_length=300, blank=True)
    product_name = models.CharField(max_length=200)
    regular_price = models.DecimalField(max_digits=12, decimal_places=2)
    tax_category_name = models.CharField(max_length=100)
    image_url = models.URLField(max_length=500, blank=True, null=True)  # Save image URL here
    category_name = models.CharField(max_length=100)
    qty = models.DecimalField(max_digits=10, decimal_places=3, default=0, null=False)
    deposit_category_name = models.CharField(max_length=100, blank=True, null=True)
    unit_type = models.CharField(max_length=15, default='pcs')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)

    # Add any fields needed for your validation/error tracking
